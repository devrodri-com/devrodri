...
describe("application routing", () => {
  ...
  it("provides portfolio return, DevRodri CTA, public links, and one cover", async () => {
    ...
    expect(screen.getAllByRole("img", { name: "Logo de LEM-BOX con el lema «Logística en Miami»" })).toHaveLength(
      1,
    );
    expect(screen.getByRole("img", { name: "Logo de LEM-BOX con el lema «Logística en Miami»" })).toHaveAttribute(
      "width",
      "1200",
    );
    expect(screen.getByRole("img", { name: "Logo de LEM-BOX con el lema «Logística en Miami»" })).toHaveAttribute(
